...
- The hero should open with a brief title and supporting-copy reveal. The mobile title is centred within its own composition and opens through a restrained tile mask. A pixel mark may remain on desktop only. Never leave static tile decoration near the mobile hero title, clip a glyph, or compress desktop decoration into the mobile hero.
