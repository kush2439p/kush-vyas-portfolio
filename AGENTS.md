...
- The hero should open with a brief title and supporting-copy reveal. The mobile title is centred within its own composition and may use a restrained animated tile field. Never clip a glyph or compress desktop decoration into the mobile hero.
